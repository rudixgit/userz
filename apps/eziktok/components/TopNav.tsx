    ...
    <div tabIndex={0} className={className}>
      {user?.username ? (
        ...
        <div tabIndex={0} className={className}>
          ...
          <div className='navlink'>
            <Link href='/auth?section=signup'>Регистрация</Link>
          </div>
        </div>
      )}
      ...
      <div className='navlink'>
        <label className='rotateswap swap'>
          ...
          />
          <svg
            className='swap-off h-8 w-8 fill-white dark:fill-black'
          ...
          <svg
            className='swap-on h-8 w-8fill-white dark:fill-black'
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
          >
