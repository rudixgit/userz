(function (e) {
  ...
  e.fn.percentageLoader = function (t) {
    ...
    y = h.createLinearGradient(v, v * 0.133333, v, i.height - v * 0.133333);
    ...
    M = function () {
      ...
      (function () {
        ...
        i = r.height * 0.16666666 - n;
        o.style.top = (r.height * 0.8333333 + i / 4).toString() + "px";
      })();
    };
    _ = function () {
      if (p < 0) {
