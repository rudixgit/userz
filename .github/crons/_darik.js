...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://dariknews.bg/novini", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                ...
                links1 = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    ...
                    .filter(function (href) { return href !== null && href.includes('dariknews.bg') && href.split('-').length >= 4; });
                links = links1.filter(unique).map(function (link) { return "https:".concat(link); });
                console.log(links);
