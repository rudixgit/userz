        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db.insert({ _id: url })];
                case 2:
                    _b.sent();
...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, d, links;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://m.dir.bg/dnes/latest-news", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                d = _a.sent();
                links = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    .map(function (link) { return link.getAttribute("href"); })
                    .filter(function (href) { return href !== null && !href.includes('javascript:') && !href.includes('viber:') && href.split('-').length >= 5; });
