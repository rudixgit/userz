...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.capital.bg/all/", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                ...
                links1 = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    ...
                    .filter(function (href) { return href !== null && href.split('_').length >= 5 && href.includes('20') && !href.includes('apital') && !href.includes('2019'); });
                links = links1.filter(unique).map(function (x) { return 'https://www.capital.bg' + x.replace('..', ''); });
                console.log(links);
                //await Promise.all(links.map((link) => getArticle(link)));
...
getArticle('https://www.capital.bg/politika_i_ikonomika/bulgaria/2023/04/02/4465772_vechnata_drujba_ot_energetikata/').then(function () { return console.log('done'); });
