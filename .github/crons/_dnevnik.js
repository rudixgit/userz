...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.dnevnik.bg/novini/dnes/", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                ...
                links1 = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    ...
                    .filter(function (href) { return href !== null && !href.includes('https') && !href.includes('javascript:') && !href.includes('/comments') && !href.includes('viber:') && href.split('_').length >= 6; });
                links = links1.filter(unique).map(function (item) { return 'https://www.dnevnik.bg' + item; });
...
//getArticle('https://www.dnevnik.bg/analizi/2023/04/04/4468300_rezultatut_ot_izborite_vsiaka_koza_za_svoi_krak/').then(() => console.log('done'));
