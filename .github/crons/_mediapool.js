            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    docx = {
                        ...
                        html: (0, sanitize_1.filterSanitizedHTML)(pimgtags, ["подкрепете ни", "Ще се радваме, ако ни подкрепите", "Екипът на Mediapool Ви", "Редакцията не носи отговорност", "Коментирането под", "Прочетете нашите правила", "За да коментирате,"]),
                        nid: (0, ulid_1.ulid)(),
                        type: 'NewsBG',
...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.mediapool.bg/today.html", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                ...
                links1 = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    ...
                    .filter(function (href) { return href !== null && !href.includes('-cat') && !href.includes('/users') && href.includes('.html') && !href.includes('/page') && href.split('-').length >= 3; });
