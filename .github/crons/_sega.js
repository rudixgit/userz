            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    docx = {
                        ...
                        html: (0, sanitize_1.filterSanitizedHTML)(pimgtags, [" Ако искате да подкрепите"]),
                        nid: (0, ulid_1.ulid)(),
                        type: 'NewsBG',
...
var go = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.segabg.com", {
                    method: "GET",
                    headers: headers,
                })];
            case 1:
            ...
            case 2:
                ...
                links1 = Array.from(new jsdom_1.JSDOM(d).window.document.querySelectorAll("a"))
                    ...
                    .filter(function (href) { return href !== null && href.split('-').length >= 5 && !href.includes('video') && href.split('/').length === 3; });
                links = links1.filter(unique).map(function (link) { return "https://www.segabg.com".concat(link); });
                console.log(links);
